...
// router.get('/own', authenticate, ctrl.getUserNotices)
// router.get('/favorite', authenticate, ctrl.getNoticeByFavorite)
...
// router.patch('/:noticeId', authenticate, ctrl.updateFavorite)
